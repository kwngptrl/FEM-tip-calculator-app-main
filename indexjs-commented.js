...
/* If it's the last radiobutton, its value must come from the input field and should be numeric with/out decimal point. */
...
/* Uses event delegation, will update the result container if there is a change within the form */
...
function watchArrowKeys(e) {
    ...
    /* If input is invalid, adds red border color */
